...
def main():
  ...
  plistpath = scriptpath + "/resources/RM07-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/RM07-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/RM07-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/RM07-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/RM07-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/RM07.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/RM07.iss",inplace=1):
