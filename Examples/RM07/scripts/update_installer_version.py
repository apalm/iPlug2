...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=RM07 Demo Installer\n"
      else:
        line="OutputBaseFilename=RM07 Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the RM07 Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the RM07 installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=RM07 Demo installer\n"
     else:
       line="SetupWindowTitle=RM07 installer\n"
